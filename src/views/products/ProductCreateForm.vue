  ...
  <div class="product-create-form">
    <div class="form-content">
      ...
      <div class="field">
        ...
        <AutoComplete id="category" v-model="formData.category" dropdown :suggestions="categories"  placeholder="Creala o buscala"/>
      ...
      <!-- Campo: stock inicial -->
      <div class="field">
        <label for="current_stock" class="required">Stock inicial</label>
        <InputNumber
          id="current_stock"
      ...
      <div class="field">
        <label for="min_stock_alert" class="required">Alerta minimo de stock</label>
        <InputNumber
          id="min_stock_alert"
