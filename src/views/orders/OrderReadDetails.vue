...
<template>
  <div class="flex items-center flex-col gap-4">
    <div class="flex justify-center max-w-xl flex-wrap gap-10">
      ...
      <div class="w-full flex flex-wrap gap-4">
        <h3 class="text-lg flex-[1_2_100%] text-surface-200">Detalles ({{ productsQuantity}})</h3>
      ...
      <div class="w-full flex flex-wrap gap-4">
        ...
        <div class="flex flex-col flex-[1_2_200px] gap-y-2" v-if="!!recordData.notes">
          <InputGroup>
            ...
            <FloatLabel variant="in">
              <Textarea disabled id="notes" v-model="recordData.notes" autoResize="" />
...
const productsQuantity = computed(() => {
  const pluralOrSingular = (props.recordData.order_details.length > 1) ? ' productos' : ' producto'
  return props.recordData.order_details.length + pluralOrSingular
})
</script>
